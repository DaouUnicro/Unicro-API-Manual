...
제휴사 가입 계정의 필수값 : 이름, 휴대폰번호(이상 본인인증 값), 아이디(제휴사 연동값)입니다.

| 구분   | 정책                                                                            |
| ---- | ----------------------------------------------------------------------------- |
| 가입   | 판매자 : 상품등록 시점 회원 가입/ 구매자 : 결제 시점 회원 가입                                        |
| 탈퇴   | 제휴사 회원 탈퇴 시 연동된 유니크로 회원계정도 동시에 탈퇴된다.                                          |
| 가입불가 | <p>회원가입 불가</p><p>외국인, 14세 미만, 하루안에 탈퇴 후 재가입 시, 한달에 2번 탈퇴하고 3번째 재가입 시</p>      |
| 휴면   | <p>- 휴면처리 : 1년 이상 미접속 시 휴면처리(휴면계정별도보관)</p><p>- 휴면복구 : 복구신청 후 최대 20분 이내 복구</p> |
...
<figure><img src="../.gitbook/assets/그림1 (2).png" alt=""><figcaption><p>거래상태 및 출금상태표 (붉은색 음영 거래종료로 상태변경 불가)</p></figcaption></figure>
